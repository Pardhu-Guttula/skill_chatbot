...
def get_model_response(prompt):
    ...
    skill_variations = {
        "ui/ux designer": ["ui/ux designer", "ux/ui designer", "user interface designer", "user experience designer", "ux designer", "ui designer"],
        "ai engineer": ["ai engineer", "artificial intelligence engineer", "ai developer"],
        "devops engineer": ["devops engineer"],
        "data scientist": ["data scientist"],
        "cloud engineer": ["cloud engineer"],
        "ux technology": ["ux technology", "user experience technology", "user interface technology"]
    ...
    def get_skill_similarity(row):
        ...
        similarity = cosine_similarity(prompt_embedding, model.encode(skill).reshape(1, -1))[0][0]
        return similarity
